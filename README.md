...
> on OpenAI while allowing DeepSeek and other configured Responses-compatible models as subagents.
...
> [Chinese quick start](./contrib/deepseek-subagents/README.md).
